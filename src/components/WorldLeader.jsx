  ...
  return (
    <div>
        <Container className='mb-10 bg-[#F7F9FB] '>
            <TitleHeader className='my-12  leading-snug text-center' headerText='World Leaders in Puddy Process Excellence Latest Innovation, Quality Execution Grain/Puddy Processing Machine.' />
            ...
            <div className='flex justify-center'>
              <img className='max-w-[700px] h-auto object-cover rounded-xl w-full' src="/WorldLeaderPuddyMachine/puddy1jpg.jpg" alt="" />
            </div>
        </Container>
    </div>
  )
