  ...
  return (
    <div>
        <Container className='mb-10'>
            <TitleHeader className='my-12 text-[35px] text-center' headerText='World Leaders in Puddy Process Excellence Latest Innovation, Quality Execution Grain/Puddy Processing Machine.' />
            ...
            <div className='flex justify-center'>
              <img src="/public/WorldLeaderPuddyMachine/puddy1jpg.jpg" alt="" />
            </div>
        </Container>
    </div>
  )
