...
const Gallery = () => {
  ...
  const images = {
    showAll: [
      ...
      { src: "/Gallery/gallery_4.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 4" },
      { src: "/Gallery/gallery_5.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 5" },
      { src: "/Gallery/gallery_6.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 6" },
      { src: "/Gallery/gallery_7.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 7" },
      { src: "/Gallery/gallery_8.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 8" },
      { src: "/Gallery/gallery_9.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 9" },
      { src: "/Gallery/gallery_10.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 10" },
      { src: "/Gallery/gallery_11.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 11" },
      { src: "/Gallery/gallery_12.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 12" },
      { src: "/Gallery/gallery_13.jpg", alt: "Image 1", caption: "High-Performance Rice Mill 13" },
